...
public @interface AuthorizedUserFeignClient {
	 ...
	 *
	 * Can contain override <code>@Bean</code> definition for the pieces that make
	...
	/**
	 * Fallback class for the specified Feign client interface. The fallback class
	 * must implement the interface annotated by this annotation and be a valid
	 * Spring bean.
	 */
